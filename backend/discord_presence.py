...
# No button. A Rich Presence button is a link every one of your friends
# sees and can click, pointing at a repository this build is not.
_BUTTONS: list[dict[str, str]] = []
