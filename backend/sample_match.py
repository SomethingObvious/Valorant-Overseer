...
def match_detail(match_id: str, subject: str | None = None) -> dict[str, Any]:
    ...
    for i in range(10):
        ...
        players.append(
            {
                "puuid": subject if is_subject else sample_data.fake_puuid(rng),
                "name": "This player" if is_subject else sample_data.make_name(rng),
        ...
        out.append(
            {
                ...
                "agents": rng.sample(sample_data.AGENT_NAMES, rng.randint(1, 3)),
            }
        )
    return out
